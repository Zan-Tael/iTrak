 ...
 * @author ZAEL
 */
public class D_InsertData extends javax.swing.JFrame {

    /**
     * Creates new form D_InsertData
     */
    public D_InsertData() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_InsertData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new D_InsertData().setVisible(true);
            }
        });
    }
